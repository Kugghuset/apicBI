 ...
 *
 * Will retry up to 1000 times with a delay between each retry.
 *
 * The first 30 minutes, the delay will be a random number between 15 and 25 seconds,
 * after 30 minutes, the delay will be between 30 and 50 seconds,
 * after 2 hours, the delay will be between 150 and 300 seconds.
 *
...
function remoteAuth(attempts, dateFirstAttempt) {
    ...
    .then(function (data) {
        ...
        var _ms = _.random(15 * _multiplier, 25 * _multiplier);
