    ...
    return new Promise(function(resolve, reject) {
        _context.acquireTokenWithUsernamePassword(
            ...
            function(err, response) {
                ...
                logger.log('New token gotten', 'info', _.assign({}, _auth, { method: 'remote' }));
    ...
    return new Promise(function(resolve, reject) {
        _context.acquireTokenWithRefreshToken(
            ...
            function(err, response) {
                ...
                logger.log('New token gotten', 'info', _.assign({}, _auth, { method: 'refresh' }));
...
function setTokenData(token, refreshToken, expiresOn) {
    ...
    logger.log('Token data set', 'info', _auth);
;
}
