...
AzureAuth.prototype = {
    ...
    /**
     * Get token for Azure API. If *getNew* is set, it goes straight to acquireToken
     * 
     * @param {boolean} getNew
     * @return {object} Promise of token or error
     */
    getToken: function(getNew) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if(!getNew && that.tokenExpiresOn && moment().add(5, 'minutes').isBefore(that.tokenExpiresOn)) {
            ...
            } else if(!getNew && that.tokenExpiresOn && moment().isBetween(that.tokenExpiresOn.subtract(5, 'minutes'), that.tokenExpiresOn)) {
